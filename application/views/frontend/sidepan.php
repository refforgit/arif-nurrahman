...
<section id="slider_sec" class="section md-padding">.
<div class="bg-img" style="background-image: url('<?php echo $this->config->item('site_url')?>/assets/img/cs6.gif');">
	...
	<div class="container">
		<div class="row">
			<div class="slider">
				  ...
				  <?php foreach($lstbox->result() as $lstbx)
							{
					if($lstbx->stts>0) 
					{ 
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
				<div class="title_sec">
					<h1>TENTANG KAMI</h1>
					<h2>KAMI WEB DEVELOPER DARI PAKUNIRAN KABUPATEN PROBOLINGGO</h2>
				</div>			
			</div>		
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
				<div class="abt">
					<p>Membangun Desa Dengan Digital Platform Knowledgement, knowledgement sharing ini dimaksudkan agar masyarakat desa pada khususnya bisa memanfaatkan teknologi digital untuk kepentingan pribadi, golongan maupun dalam dunia Bisnis</p>
				</div>
			</div>			
		</div>
	</div>
...
<section id="counting_sec" class="section md-padding">
<div class="bg-img" style="background-image: url('<?php echo $this->config->item('site_url');?>assets/img/blog.jpg');">
			<div class="overlay"></div>
			</div>
<div class="container">
	<div class="row">	
...
<section id="tstm_sec" class="section md-padding">
<div class="bg-img" style="background-image: url('<?php echo $this->config->item('site_url');?>assets/img/background2.jpg');">
			<div class="overlay"></div>
		</div>
	<div class="container">
		<div class="row">
...
<section id="ltd_map_sec">
	...
	<div class="row">
		<div class="col-xs-offset-0">
					...
					<script>
      function initMap() {
        var uluru = {lat: -7.797157, lng: 113.517236};
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA-3X4HNoyxPWi-WMckgiEwJ2xdIXoLdEc&callback=initMap">
    </script>
