	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12">
				<div class="lft_hd">
					<a class="page-scroll" href="#home"><img src="img/logo.png" alt=""/></a>
				</div>
			</div>			
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Our Another Page <span class="fa fa-angle-down"></span></a>
...
<div class="bg-img" style="background-image: url('https://balijungletrekking.files.wordpress.com/2016/10/how-to-visit-bukit-jambul-bali-in-karangasem.png');">
